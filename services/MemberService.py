...
class MemberService:
    ...
    def register_member(self,username: str,first_name:str,operator_id: UUID) -> CreatedMemberResponse:
        member = self._member_repo.create_member(username,first_name,operator_id)
    ...
    def reset_member_pin(self, member_id: UUID) -> None:
        ...
        return new_pin
    def generate_member_deep_link(self,operator_id: UUID, member_id: UUID) -> MemberGenerateDeepLinkResponse:
