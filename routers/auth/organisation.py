...
def signup_organisation(body: OrganisationSignupRequest, organisation_service: OrganisationAuthServiceDEP):
    ...
    return OrganisationSessionResponse(organisation=OrganisationResponse(id=session_response.organisation.id,email=session_response.organisation.email,organisation_name=session_response.organisation.organisation_name),session=session_response.session) 
