...
def signup_licenseholder(body: LicenseHolderSignupRequest, licenseholder_service: LicenseHolderAuthServiceDEP):
    ...
    return LicenseHolderSessionResponse(licenseholder=LicenseHolderResponse(id=session_response.licenseholder.id,email=session_response.licenseholder.email),session=session_response.session) 
