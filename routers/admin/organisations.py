...
from blustorymicroservices.BluStoryAccounts.dependencies.services import get_operator_service, get_organisation_service, get_organisation_admin_service
...
from blustorymicroservices.BluStoryAccounts.services import OperatorService, OrganisationService, OrganisationAdminService
...
OrganisationAdminServiceDEP = Annotated[OrganisationAdminService, Depends(get_organisation_admin_service)]
...
def create_and_assign_organisation_admin(
    ...
    organisation_admin_service: OrganisationAdminServiceDEP,
    current_organisation_admin: AuthenticatedOrganisationAdminDEP,
):
    organisation_id = current_organisation_admin.organisation_id
    
    email = body.email
    return organisation_admin_service.create_and_assign_organisation_admin(email,organisation_id)
